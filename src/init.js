...
module.exports = function(options, done) {
  ...
  async.auto({
    ...
    assetCategoryManager: function (cb) {
      var AssetCategoryManager = require('./utils/asset-category.js')
      var acm = new AssetCategoryManager
      var categoryFile = path.join(appConfig.baseDir, 'asset-category.csv');
      acm.parse(fs.readFileSync(categoryFile, 'utf8'))
      cb(null, acm)
    },
    ...
    modules: ['network', 'connect', 'config', 'logger', 'bus', 'sequence', 'dbSequence', 'balancesSequence', 'dbLite', 'base', 'oneoff', 'balanceCache', 'model', 'assetCategoryManager', function (cb, scope) {
