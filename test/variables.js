...
var Eaccount = {
  ...
  'balance': 0,
  'delegateName': 'virtual_delegate_1'
};

// Account info for genesis account - Needed for voting, registrations and Tx
var Gaccount = {
  'address': 'AMQ4twBCu56gExrv52kbcFML1bQcLpCAen',
  'publicKey': 'ec50cd05b4128baecbe5e8bcd5cc2d3d4d0790e76dff5b94f798d44bf188bd7d',
  'password': 'dinner mention gadget chief embody neglect sort gentle trial pitch rice reopen',
...
function randomCoin() {
  return String(Math.floor(Math.random() * (1000 * 1000000)) + (100 * 1000000));
}
